...
JNIEXPORT jint JNICALL Java_com_vectras_vm_core_NativeFastPath_nativePlatformSignature(JNIEnv* env, jclass clazz){(void)env;(void)clazz;RmR_UnifiedCapabilities c; if(vectra_kernel_ensure()!=RMR_KERNEL_OK||RmR_UnifiedKernel_QueryCapabilities(&g_unified_state,&c)!=RMR_KERNEL_OK)return 0; return (jint)c.signature;}
JNIEXPORT jint JNICALL Java_com_vectras_vm_core_NativeFastPath_nativePointerBits(JNIEnv* env, jclass clazz){(void)env;(void)clazz;RmR_UnifiedCapabilities c; if(vectra_kernel_ensure()!=RMR_KERNEL_OK||RmR_UnifiedKernel_QueryCapabilities(&g_unified_state,&c)!=RMR_KERNEL_OK)return 32; return (jint)c.pointer_bits;}
JNIEXPORT jint JNICALL Java_com_vectras_vm_core_NativeFastPath_nativeCacheLineBytes(JNIEnv* env, jclass clazz){(void)env;(void)clazz;RmR_UnifiedCapabilities c; if(vectra_kernel_ensure()!=RMR_KERNEL_OK||RmR_UnifiedKernel_QueryCapabilities(&g_unified_state,&c)!=RMR_KERNEL_OK)return 64; return (jint)c.cache_line_bytes;}
JNIEXPORT jint JNICALL Java_com_vectras_vm_core_NativeFastPath_nativePageBytes(JNIEnv* env, jclass clazz){(void)env;(void)clazz;RmR_UnifiedCapabilities c; if(vectra_kernel_ensure()!=RMR_KERNEL_OK||RmR_UnifiedKernel_QueryCapabilities(&g_unified_state,&c)!=RMR_KERNEL_OK)return 4096; return (jint)c.page_bytes;}
JNIEXPORT jint JNICALL Java_com_vectras_vm_core_NativeFastPath_nativeFeatureMask(JNIEnv* env, jclass clazz){(void)env;(void)clazz;RmR_UnifiedCapabilities c; if(vectra_kernel_ensure()!=RMR_KERNEL_OK||RmR_UnifiedKernel_QueryCapabilities(&g_unified_state,&c)!=RMR_KERNEL_OK)return 0; return (jint)c.feature_mask;}
